...
class ResumeStyle(StrictModel):
    font: Literal[
        "Arial", "Calibri", "Georgia", "Times New Roman", "Verdana", "System Sans"
    ] = "Arial"
...
class ResumeSection(StrictModel):
    ...
    separator: Annotated[
        str, StringConstraints(strip_whitespace=False, max_length=10)
    ] = " · "
...
class RichNode(StrictModel):
    ...
    text: (
        Annotated[str, StringConstraints(strip_whitespace=False, max_length=50000)]
        | None
    ) = None
