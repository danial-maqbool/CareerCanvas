...
KINDS = {
    ...
    'projects': Project, 'achievements': Achievement, 'certifications': Certification,
    'publications': Publication, 'languages': Language, 'references': Reference,
    'portfolio': PortfolioItem,
}
Kind = Literal['experience', 'education', 'skills', 'projects', 'achievements', 'certifications', 'publications', 'languages', 'references', 'portfolio']
