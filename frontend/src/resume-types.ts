...
export type Resume = {id:string, name:string, purpose:string, target_role:string, document:ResumeDocument, archived:boolean, primary:boolean, revision:number, updated_at:string, created_at:string}
