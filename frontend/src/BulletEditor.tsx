...
export default function BulletEditor({sectionId,itemId,onClose}:{sectionId:string,itemId:string,onClose:()=>void}){
  ...
  const [notice,setNotice]=useState(''),[aiBullet,setAiBullet]=useState<string|null>(null)
