...
test('career profile CRUD survives a reload and demo refuses overwrite', async ({ page, request }) => {
  ...
  await page.getByLabel('Achievement bullets').fill('Developed 14 APIs used by three teams.\nReduced query latency by 25%.')
